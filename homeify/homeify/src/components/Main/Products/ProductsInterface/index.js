...
export default function Trends({ data, data2 }) {
  return (
    <>
      <div className="trend_collection_sponsor">
        <div className="div1fur">
          <h1 id="hedtag">Follow Trends In Them</h1>
          <div id="trend_div">
            {data.length ? (
              data.map((item) => (
        ...
        <div className="div2fur">
          <h1 id="hedtag">Check Out These Curated Collections</h1>
          <div className="div2fur-grid">
        ...
        <div className="div3fur">
          <h1 id="hedtag">Explore Popular Brands</h1>
