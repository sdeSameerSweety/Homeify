                  ...
                  <div className=" flex flex-col gap-5">
                    ...
                    <div className="flex flex-col gap-3">
                      <div className="flex justify-between">
                        <span className="font-ubuntu">{address1[0].name}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="font-ubuntu">
                          {address1[1].address}&nbsp;{address1[2].city}&nbsp;
                          {address1[3].District}&nbsp;{address1[4].State}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="font-ubuntu">
            ...
            >
              <Card.Body>
                <Text>
                  ...
                  <div className="button-div flex justify-end gap-2">
                      <Link to="/editaddress"><Button shadow auto css={{
                        backgroundColor:"white",
                        color:"#FF7035",
                        boxShadow:"none",
                        border:"2px solid #FF7035",
